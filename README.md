...
查看manifest仓库请转移到 [https://github.com/viruscoding/aapt-repo-manifest](https://github.com/viruscoding/aapt-repo-manifest)
...
#初始化并同步源码树，约3G
repo init -u https://github.com/viruscoding/aapt-repo-manifest.git -b android-13.0.0_r8 --depth 1
repo sync -j8
```
